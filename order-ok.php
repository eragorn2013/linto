	...
	<div class="container order-ok-container">
		<div class="content">
			...
			<div class="order-ok-info">
				...
				<p class="order-ok-info-p">Скидка по купону составила <span class="order-ok-info-p-bold">186 RUB</span></p>
				<p class="order-ok-info-p">Для подтверждения заказа <span class="order-ok-info-p-bold">наш менеджер свяжется с Вами</span> по указанному в заказе телефону или электронной почте.</p>
			</div>
