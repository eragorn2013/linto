			...
			<div class="card-info">
				...
				<div class="card-info-colors-list">
					<h2 class="card-info-colors-head">
						<span class="card-info-colors-head-name">ОТТЕНКИ КОЛЛЕКЦИИ</span>
						<span class="card-info-colors-head-count">(12)</span>
					</h2>
				...
				<div class="card-info-desc">
					...
					<div class="card-info-desc-wrap">
						<p class="card-info-desc-p">Гель-лак для ногтей LiNTO. Только для профессионального использования.</p>
						<p class="card-info-desc-p">Не имеет резкого запаха, самовыравнивается  и не затекает под кутикулу, плотная пигментация цвета. Снимается как спиливанием, так и растворением.</p>
					</div>
				</div>
				<div class="card-info-test">
					<h2 class="card-info-test-head">ПРОТЕСТИРОВАТЬ ПРОДУКТ</h2>
					<div class="card-info-test-wrap">
						<p class="card-info-test-p">Вы можете ознакомиться с данным товаром, а также с остальными продуктами в нашем центральном офисе в  г. Москва, ул. Лубянка, д. 1, оф. 1</p>
					</div>
				</div>
